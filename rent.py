...
def create_url(zipcode, filter,page):
    ...
    baths = '2.0'
    if filter == "newest":
        url = "https://www.zillow.com/homes/for_rent/{0}/houses/{2}-_beds/{3}-_baths/{1}_p/days_sort".format(zipcode,page,beds,baths)
    elif filter == "cheapest":
        url = "https://www.zillow.com/homes/for_rent/{0}/houses/{2}-_beds/{3}-_baths/{1}_p/0_singlestory/pricea_sort/".format(zipcode,page,beds,baths)
    else:
        url = "https://www.zillow.com/homes/for_rent/{0}/houses/{2}-_beds/{3}-_baths/{1}_p/0_singlestory/priced_sort/".format(zipcode,page,beds,baths)
    print(url)
    return url
...
def write_data_to_csv(data):
    ...
    with open("properties-rent-%s.csv" % (zipcode), 'wb') as csvfile:
        fieldnames = ['id',
                'address',
                'city',
                'state',
